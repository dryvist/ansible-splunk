...
* **silence-exemptions:** remove stale hindsight never-ingested exemption ([085201e](https://github.com/dryvist/ansible-splunk/commit/085201e877bc8ee26c75f94d610f0cf94e57c78b))
...
* **splunk:** add the cribl_internal index ([#601](https://github.com/dryvist/ansible-splunk/issues/601)) ([48eccbd](https://github.com/dryvist/ansible-splunk/commit/48eccbd0496fc3e153f8d65318fb52b10cc3e932))

## [0.81.2](https://github.com/dryvist/ansible-splunk/compare/v0.81.1...v0.81.2) (2026-09-25)


### Bug Fixes

* **splunk:** add the docling index ([#599](https://github.com/dryvist/ansible-splunk/issues/599)) ([924933d](https://github.com/dryvist/ansible-splunk/commit/924933d81353ea11cec24be1be43cc67612a74b6))
...
* **alerts:** alert on every github-admin-claude OpenBao login ([#594](https://github.com/dryvist/ansible-splunk/issues/594)) ([927330b](https://github.com/dryvist/ansible-splunk/commit/927330b25a0a1a7f7da1096763073e559a5c4a1b))

## [0.80.0](https://github.com/dryvist/ansible-splunk/compare/v0.79.0...v0.80.0) (2026-09-23)


### Features

* **splunk_docker:** add PVE ZFS I/O-stall detector ([#592](https://github.com/dryvist/ansible-splunk/issues/592)) ([e6104cc](https://github.com/dryvist/ansible-splunk/commit/e6104cc45eec9e1316f4421226acb1045998e37a))

## [0.79.0](https://github.com/dryvist/ansible-splunk/compare/v0.78.0...v0.79.0) (2026-09-22)


### Features

* **splunk:** add openbao ingress backend-burst alert ([#589](https://github.com/dryvist/ansible-splunk/issues/589)) ([5a0e4cc](https://github.com/dryvist/ansible-splunk/commit/5a0e4ccfd456cc10f4d43fa2f0e179fe67a8e65d))

## [0.78.0](https://github.com/dryvist/ansible-splunk/compare/v0.77.2...v0.78.0) (2026-09-22)


### Features

* **splunk:** add a Terrakube job-error detector ([#588](https://github.com/dryvist/ansible-splunk/issues/588)) ([e1e1424](https://github.com/dryvist/ansible-splunk/commit/e1e14248ed13b8fe2b0427c7c8055cad86f2c677))

## [0.77.2](https://github.com/dryvist/ansible-splunk/compare/v0.77.1...v0.77.2) (2026-09-19)


### Bug Fixes

* **ci:** cache Galaxy collections in the data-contract workflow ([b4904ed](https://github.com/dryvist/ansible-splunk/commit/b4904ed951ceacf6ea422fcd7f03c3a466806b87))
* **ci:** cache Galaxy collections in the data-contract workflow ([0212629](https://github.com/dryvist/ansible-splunk/commit/0212629536dab2256d144fd0b00149105dba04a0))

## [0.77.1](https://github.com/dryvist/ansible-splunk/compare/v0.77.0...v0.77.1) (2026-09-19)


### Bug Fixes

* **ci:** forward the router secrets to ai-pr-care with secrets: inherit ([37de88c](https://github.com/dryvist/ansible-splunk/commit/37de88c7be12fd3c2db899f562e5ddcb30dbf110))
* **ci:** forward the router secrets to ai-pr-care with secrets: inherit ([a8e5a9c](https://github.com/dryvist/ansible-splunk/commit/a8e5a9cdab4cca569f75e1d87d1c1247ea9fa0f8))
...
* **runner:** authenticate as the execution plane's own identity when its credential is present ([#561](https://github.com/dryvist/ansible-splunk/issues/561)) ([2f5b4a4](https://github.com/dryvist/ansible-splunk/commit/2f5b4a44f5cef20b1237221b54830238067d14bc))
...
* **splunk:** apply saved-search overrides through the REST API ([239a1ae](https://github.com/dryvist/ansible-splunk/commit/239a1ae1d7a00c4608bb4600022ff017bd351a50))


### Bug Fixes

* **splunk:** declare saved-search overrides in inventory, not role defaults ([b5a89e5](https://github.com/dryvist/ansible-splunk/commit/b5a89e52c1e1ae071b4a813106d192b2745fbe9f))

## [0.71.2](https://github.com/dryvist/ansible-splunk/compare/v0.71.1...v0.71.2) (2026-09-11)


### Bug Fixes

* **splunk_docker:** pin the image so a version bump is actually pulled ([30470fe](https://github.com/dryvist/ansible-splunk/commit/30470fe6197b8aa5c8e6842e835b74fff60ba05c))

## [0.71.1](https://github.com/dryvist/ansible-splunk/compare/v0.71.0...v0.71.1) (2026-09-11)


### Bug Fixes

* **playbooks:** tag the Splunkbase mirror play so a converge can skip it ([#550](https://github.com/dryvist/ansible-splunk/issues/550)) ([a170892](https://github.com/dryvist/ansible-splunk/commit/a17089241bfe2bad8e613eee17e533a8d753c89b))
